...
if (args.doctor) {
  ...
  if (!health.ok || !mcpRuntime || !mcpTools || (!codexMcp && !claudeMcp) || !provider.ok || !providerAuth.ok || !codexActivation || !claudeActivation) process.exitCode=1
  process.exit()
}
