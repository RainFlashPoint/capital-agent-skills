...
const child = spawn(process.execPath, [proxy, `${serverUrl}/api/mcp/message`, '--header', `x-user-key:${userKey}`], { stdio: 'inherit', env: { ...process.env, CAPITAL_AGENT_SERVER_URL: serverUrl, NODE_OPTIONS: nodeOptions } })
